...
Public Class ScanList
    ...
    Private _CurrentRecord As ScanRecord
    Private _Records As New ScanRecords
    Private _iRecordCount As Integer

    ' Collection of ScanList Records

    Public ReadOnly Property Records() As ScanRecords
        Get
            Return _Records
        End Get
    End Property
    ...
    Sub New(ByRef p_dsDataSet As DataSet)
        ...
        Try
            ...
            _CurrentRecord = New ScanRecord 'Make sure there is a valid record for immediate use
        ...
        Try
            ...
            Do
                ...
                If strCurrentLine Is Nothing Then
                    ...
                    Exit Do
                Else
                    Dim objRecord As New ScanRecord
